...
namespace crudCliente.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Endereco,Telefone")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Endereco,Telefone")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
